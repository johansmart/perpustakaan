            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel jenis_out</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/jenis_out/jenis_outadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($jenis_out as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_jenis_out</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/jenis_out/jenis_out_edit?id='.$ktg->id_jenis_out)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/jenis_out/jenis_out_delete?id='.$ktg->id_jenis_out)."\">
