            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				$inisial_barcode="MEZ-INV-";
					  echo"
					  <form enctype='multipart/form-data' id='form_send' action='".base_url('index.php/inventory_out/inventory_outedit_proses')."' method='post'>
					
					
					<div class='form-group'>
                      <label for='exampleInputEmail1'>Barcode inventory_out</label> format : $inisial_barcode
						<div class='input-group'>
						  <input type='hidden' id='id_inventory_out' name='id_inventory_out' class='form-control'  value='".$inventory->id_inventory_out."'  required='' placeholder='id'>	
						<input type='text' name='barcode'   id='barcode_input' onkeyup='myFunction()'   class='form-control'  value='".$inventory->barcode_inventory."'  required='' placeholder='no id barcode inventory_out'>
                    ...
                    <div class='input-group'>
                      ...
                      <input type='text' id='tanggal' name='tgl' value='".$inventory->tgl_inventory_out."' id='tanggal' class='form-control'  style='height:35px;' placeholder='yyyy/mm/dd'  required='' />
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
					...
					<div class='form-group'>
                      ...
                      <input type='number' id='jumlah' name='jumlah' class='form-control'  value='".$inventory->jumlah_inventory_out."' id='exampleInputEmail1' required='' placeholder='jumlah'>
					</div>
					";
					//jenis in
					...
					<option value=".$inventory->id_jenis_out." >".$inventory->nama_jenis_out."</option>
					";
                    ...
                    <textarea  name='ket' rows='10' cols='80' >".$inventory->keterangan_inventory_out."</textarea>
					</div>
					";
                  ...
                  <div class='box-footer'>
					...
					<a href='".base_url('index.php/inventory_out/')."' class='btn btn-primary' title='batal atau kembali'><b>Kembali</b></a>
...
<script type="text/javascript">
	$(function() {
		...
		$("#send").click(function(){
			...
			$.ajax({
                url: '<?php echo base_url('index.php/inventory_out/inventory_out_edit_proses');?>',
            	data : formdata,
                processData: false,
                contentType: false,
                type: 'POST',
