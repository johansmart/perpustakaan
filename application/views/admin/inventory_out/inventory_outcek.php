              ...
              <div class="box box-primary">
				...
				$inisial_barcode="MEZ-INV-";
					...
					<div class='form-group'>
                      <label for='exampleInputEmail1'>Barcode inventory_out</label> format : $inisial_barcode
						<div class='input-group'>
						  <input readonly type='hidden' id='id_inventory_out' name='id_inventory_out' class='form-control'  value='".$inventory->id_inventory_out."'  required='' placeholder='id'>	
						<input readonly type='text' name='barcode'   id='barcode_input'  class='form-control'  value='".$inventory->barcode_inventory."'  required='' placeholder='no id barcode inventory_out'>
                    ...
                    <div class='input-group'>
                      ...
                      <input  readonly type='text' id='tanggal' name='tgl' value='".$inventory->tgl_inventory_out."' id='tanggal' class='form-control'  style='height:35px;' placeholder='yyyy/mm/dd'  required='' />
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
					...
					<div class='form-group'>
                      ...
                      <input readonly type='number' id='jumlah' name='jumlah' class='form-control'  value='".$inventory->jumlah_inventory_out."' id='exampleInputEmail1' required='' placeholder='jumlah'>
					</div>
					";
					//jenis in
					echo"<div class='form-group'>
					<label for='exampleInputEmail1'>jenis_out inventory_out</label>
                    <select name='jenis_out' class='select'  style='width:100%;' id='isi_jenis_out' disabled>
                    ...
                    <textarea readonly name='ket' rows='10' cols='80' >".$inventory->keterangan_inventory_out."</textarea>
					</div>
					";
