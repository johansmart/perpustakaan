            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel klasifikasi</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/klasifikasi/klasifikasiadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($klasifikasi as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_klasifikasi</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/klasifikasi/klasifikasi_edit?id='.$ktg->id_klasifikasi)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/klasifikasi/klasifikasi_delete?id='.$ktg->id_klasifikasi)."\">
