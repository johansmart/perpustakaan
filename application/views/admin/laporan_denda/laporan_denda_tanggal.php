 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         Laporan Denda
		  ...
		  <ul class="nav nav-tabs">
			  ...
			  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/laporan_denda/tanggal'); ?>">Tanggal</a></li>
			  <li role="presentation" ><a href="<?php echo base_url('index.php/laporan_denda/bulan'); ?>">Bulan</a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Laporan Denda per tanggal </h3><p>
				<a href='<?php echo base_url('index.php/laporan_denda/denda_list_tanggal_print');?>' target='_blank' ><button class='btn btn-primary'> 
				 Print preview</button>
				 </a>
				  <p>
				 
			<?php 
				if(!isset($_GET['search_denda_tanggal'])) {
				$search_denda_tanggal="";
				}
				else {
				$search_denda_tanggal=$_GET['search_denda_tanggal'];
				}
			?>
			<?php
			if ($search_denda_tanggal<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_denda_tanggal";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_denda/tanggal');?>' method='get'>
                   <div class="input-group">
				   
                     <input type="text" name="search_denda_tanggal" id='tanggal' value='<?php echo$this->session->userdata('search_denda_tanggal'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_denda_tanggal')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_denda/tanggal?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
			...
			$total_semua_denda=$this->m_pengembalian->jumlah_list_dendatotal_tanggal();
