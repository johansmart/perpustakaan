      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">mata_pelajaran</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel mata_pelajaran</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/mata_pelajaran/mata_pelajaranadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($mata_pelajaran as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_mata_pelajaran</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/mata_pelajaran/mata_pelajaran_edit?id='.$ktg->id_mata_pelajaran)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/mata_pelajaran/mata_pelajaran_delete?id='.$ktg->id_mata_pelajaran)."\">
