              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
					  ...
					  <form action='<?php echo base_url('index.php/mata_pelajaran/mata_pelajaranadd_proses');?>' method='post'>
					   
                      <input type='text' name='mata_pelajaran' class='form-control'  value='' id='exampleInputEmail1' placeholder='nama mata_pelajaran'>
                    </div>
