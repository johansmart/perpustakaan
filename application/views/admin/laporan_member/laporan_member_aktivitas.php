 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         Laporan member
		    ...
		    <ul class="nav nav-tabs">
			  <li role="presentation"  ><a href="<?php echo base_url('index.php/laporan_member/'); ?>">Data Member</a></li>
			  <li role="presentation"class="active" ><a href="<?php echo base_url('index.php/laporan_member/memberaktivitas'); ?>">Aktivitas Member</a></li>
			</ul>
          <ol class="breadcrumb">
			<li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
				  ...
				  <p>
				   <a href='<?php echo base_url('index.php/laporan_member/memberaktivitas_print');?>' target='_blank' ><button class='btn btn-primary'> 
			...
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_member/memberaktivitas');?>' method='get'>
                   <div class="input-group">
                     <input type="text" name="search_mmbr" value='<?php echo$this->session->userdata('search_mmbr'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search_mmbr"/>
                      <div class="input-group-btn">
						...
						if ($this->session->userdata('search_mmbr')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_member/memberaktivitas?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <th style=width:13%>No Identitas</th>
                      <th style=width:23%>Nama member</th>
                      <th style=width:10%>Jenis</th>
                      <th style=width:7%>Kunjungan</th>
                      <th style=width:7%>Peminjaman</th>
				...
				foreach($member as $mn){
					...
					echo"
					<td style='vertical-align:middle'>$jumlah_absen</td>";
					...
					echo"
					<td style='vertical-align:middle'>$selisih</td>";
