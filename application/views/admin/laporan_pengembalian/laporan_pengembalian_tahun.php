 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         Laporan Pengembalian
		  ...
		  <ul class="nav nav-tabs">
			  ...
			  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/laporan_pengembalian/tahun'); ?>">Tahun</a></li>
			</ul>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Laporan Pengembalian per tahun </h3><p>
				<a href='<?php echo base_url('index.php/laporan_pengembalian/pengembalian_list_tahun_print');?>' target='_blank'  ><button class='btn btn-primary'> 
				 Print preview</button>
				 </a>
				  <p>
				 
			<?php 
				if(!isset($_GET['search_pengembalian_tahun'])) {
			...
			?>
			<?php
			if ($search_pengembalian_tahun<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_pengembalian_tahun";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_pengembalian/pengembalian_list_tahun');?>' method='get'>
                   <div class="input-group">
				   
                     <input type="number" name="search_pengembalian_tahun" value='<?php echo$this->session->userdata('search_pengembalian_tahun'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_pengembalian_tahun')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_pengembalian/pengembalian_list_tahun?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
			...
			$total_semua_denda=$this->m_pengembalian->jumlah_list_pengembaliantotal_tahun();
