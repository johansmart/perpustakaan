 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         Laporan Pengembalian
		  ...
		  <ul class="nav nav-tabs">
			  ...
			  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/laporan_pengembalian/tanggal'); ?>">Tanggal</a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Laporan Pengembalian per tanggal </h3><p>
				<a href='<?php echo base_url('index.php/laporan_pengembalian/pengembalian_list_tanggal_print');?>' target='_blank' ><button class='btn btn-primary'> 
				 Print preview</button>
				 </a>
				  <p>
				 
			<?php 
				if(!isset($_GET['search_pengembalian_tanggal'])) {
				$search_pengembalian_tanggal="";
				}
				else {
				$search_pengembalian_tanggal=$_GET['search_pengembalian_tanggal'];
				}
			?>
			<?php
			if ($search_pengembalian_tanggal<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_pengembalian_tanggal";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_pengembalian/tanggal');?>' method='get'>
                   <div class="input-group">
				   
                     <input type="text" name="search_pengembalian_tanggal" id='tanggal' value='<?php echo$this->session->userdata('search_pengembalian_tanggal'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_pengembalian_tanggal')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_pengembalian/tanggal?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
			...
			$total_semua_denda=$this->m_pengembalian->jumlah_list_pengembaliantotal_tanggal();
