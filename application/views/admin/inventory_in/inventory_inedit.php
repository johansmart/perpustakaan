            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				$inisial_barcode="MEZ-INV-";
					  echo"
					  <form enctype='multipart/form-data' id='form_send' action='".base_url('index.php/inventory_in/inventory_inedit_proses')."' method='post'>
					
					
					<div class='form-group'>
                      <label for='exampleInputEmail1'>Barcode inventory in</label> format : $inisial_barcode
						<div class='input-group'>
						  <input type='hidden' id='id_inventory_in' name='id_inventory_in' class='form-control'  value='".$inventory->id_inventory_in."'  required='' placeholder='id'>	
						<input type='text' name='barcode'   id='barcode_input' onkeyup='myFunction()' class='form-control'  value='".$inventory->barcode_inventory."'  required='' placeholder='no id barcode inventory in'>
                    ...
                    <div class='input-group'>
                      ...
                      <input type='text' id='tanggal' name='tgl' value='".$inventory->tgl_inventory_in."' id='tanggal' class='form-control'  style='height:35px;' placeholder='yyyy/mm/dd'  required='' />
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
					...
					<div class='form-group'>
                      ...
                      <input type='number' id='jumlah' name='jumlah' class='form-control'  value='".$inventory->jumlah_inventory_in."' id='exampleInputEmail1' required='' placeholder='jumlah'>
					</div>
					";
					//jenis in
					echo"<div class='form-group'>
					<label for='exampleInputEmail1'>jenis_in inventory in</label>
                    <select name='jenis_in' class='select'  style='width:100%;' id='isi_jenis_in'>
                    ...
                    <textarea  name='ket' rows='10' cols='80' >".$inventory->keterangan_inventory_in."</textarea>
					</div>
					";
