				...
				$inisial_barcode="MEZ-INV-";
					...
					<div class='form-group'>
                      <label for='exampleInputEmail1'>Barcode inventory in</label> format : $inisial_barcode
						...
						<input type='text' name='barcode'    id='barcode_input' onkeyup='myFunction()' class='form-control'  value=''  required='' placeholder='no id barcode inventory in'>
					...
					<div class='form-group'>
                       <div id='id'>
					  <input readonly type='hidden' id='id' name='id' class='form-control'  value=''  required='' placeholder='id'>
						</div>
					</div>
