              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
					  ...
					  <form action='<?php echo base_url('index.php/kota/kotaadd_proses');?>' method='post'>
					   
                      <input type='text' name='kota' class='form-control'  value='' id='exampleInputEmail1' placeholder='nama kota'>
                    </div>
