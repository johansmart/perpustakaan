            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel kota</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/kota/kotaadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					<td style='vertical-align:middle'>$ktg->nama_kota</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/kota/kota_edit?id='.$ktg->id_kota)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/kota/kota_delete?id='.$ktg->id_kota)."\">
