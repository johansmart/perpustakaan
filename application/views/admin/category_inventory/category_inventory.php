      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">category_inventory</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel category_inventory</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/category_inventory/category_inventoryadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($category_inventory as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_category_inventory</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/category_inventory/category_inventory_edit?id='.$ktg->id_category_inventory)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/category_inventory/category_inventory_delete?id='.$ktg->id_category_inventory)."\">
