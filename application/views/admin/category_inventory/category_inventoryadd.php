              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
					  ...
					  <form action='<?php echo base_url('index.php/category_inventory/category_inventoryadd_proses');?>' method='post'>
					   
                      <input type='text' name='category_inventory' class='form-control'  value='' id='exampleInputEmail1' placeholder='nama category_inventory'>
                    </div>
