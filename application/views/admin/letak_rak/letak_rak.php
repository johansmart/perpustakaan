            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel letak_rak</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/letak_rak/letak_rakadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($letak_rak as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_letak_rak</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/letak_rak/letak_rak_edit?id='.$ktg->id_letak_rak)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/letak_rak/letak_rak_delete?id='.$ktg->id_letak_rak)."\">
