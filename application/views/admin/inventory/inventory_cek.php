            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				$inisial_barcode="MEZ-INV-";
                    ...
                    <select   name='category_inventory' class='select'  style='width:100%;' id='isi_category_inventory' disabled>
                    ...
                    <select    name='pengarang' class='select'  style='width:100%;' id='isi_pengarang' disabled>
                    ...
                    <select   name='penerbit' class='select'  style='width:100%;' id='isi_penerbit' disabled>
                    ...
                    <select   name='kota' class='select'  style='width:100%;' id='isi_kota' disabled>
                    ...
                    <select   name='letak_rak' class='select'  style='width:100%;' id='isi_letak_rak' disabled>
                    ...
                    <select   name='bahasa' class='select'  style='width:100%;' id='isi_bahasa' disabled>
                    ...
                    <textarea  disabled id='editor1' name='detail' rows='10' cols='80' required=''>".$inventory->detail_inventory."</textarea>
					</div>
					";
                    ...
                    <select   name='klasifikasi' class='select'  style='width:100%;' id='isi_klasifikasi' disabled>
                  ...
                  <div class='box-footer'>
					<a href='".base_url('index.php/inventory/')."' class='btn btn-primary' title='batal atau kembali'><b>Kembali</b></a>
					
					<a href='".base_url('index.php/inventory/inventory_print?id='.$inventory->id_inventory.'')."' target='_blank'
					class='btn btn-primary' ><b>Preview</b></a>
                  </div>
                </form>";
				}
				}				
