            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
				...
				$inisial_barcode="MEZ-INV-";
					  echo"
					  <form enctype='multipart/form-data' action='".base_url('index.php/inventory/inventory_edit_proses')."' method='post'>
					
					<input type='hidden' name='id_inventory' class='form-control'  value='".$inventory->id_inventory."' id='exampleInputEmail1' required='' placeholder='no id inventory'>
                    <input type='hidden' name='barcode2' class='form-control'  value='".$inventory->barcode_inventory."'  id='barcode_inventory0' required='' placeholder='no id inventory'>
					<input type='hidden' name='isbn2' class='form-control'  value='".$inventory->ISBN."' id='exampleInputEmail1' required='' placeholder='no id inventory'>
					";
					...
					<div class='form-group'>
                      ...
                      <input type='text' name='barcode' class='form-control'  value='".$inventory->barcode_inventory."' id='barcode_inventory' onkeyup=' Function_inventory()'  required='' placeholder='no id barcode inventory'>
						<div id='cekinv'></div>
					</div>";
					...
					<option value=".$inventory->id_category_inventory." >".$inventory->nama_category_inventory."</option>
					";
					//kategory
					...
					<div class='form-group'>
                      ...
                      <input type='text' name='judul' class='form-control'  value='".$inventory->judul_inventory."' id='exampleInputEmail1' required='' placeholder='nama'>
					</div>
					";
					...
					<div class='form-group'>
                      ...
                      <input type='text' name='isbn' class='form-control'  value='".$inventory->ISBN."' id='exampleInputEmail1' required='' placeholder='isbn'>
					</div>
					";
                    ...
                    <select name='pengarang' class='select'  style='width:100%;' id='isi_pengarang'>
						<option value=".$inventory->id_pengarang." >".$inventory->nama_pengarang."</option>
					";
                    ...
                    <select name='penerbit' class='select'  style='width:100%;' id='isi_penerbit'>
						<option value=".$inventory->id_penerbit." >".$inventory->nama_penerbit."</option>
					";
                    ...
                    <select name='kota' class='select'  style='width:100%;' id='isi_kota'>
						<option value=".$inventory->id_kota." >".$inventory->nama_kota."</option>
					";
					...
					<div class='form-group'>
                      ...
                      <input type='number' name='tahun' class='form-control'  value='".$inventory->tahun."' id='exampleInputEmail1' required='' placeholder='tahun'>
					</div>
					";
                    ...
                    <select name='letak_rak' class='select'  style='width:100%;' id='isi_letak_rak'>
						<option value=".$inventory->id_letak_rak." >".$inventory->nama_letak_rak."</option>
					";
                    ...
                    <select name='bahasa' class='select'  style='width:100%;' id='isi_bahasa'>
						<option value=".$inventory->id_bahasa." >".$inventory->nama_bahasa."</option>
					";
					...
					<div class='form-group'>
                      ...
                      <input type='number' name='halaman' class='form-control'  value='".$inventory->jumlah_halaman_inventory."' id='exampleInputEmail1' required='' placeholder='halaman'>
					</div>
					";
                    ...
                    <textarea id='editor1' name='detail' rows='10' cols='80' required=''>".$inventory->detail_inventory."</textarea>
					</div>
					";
                    ...
                    <select name='klasifikasi' class='select'  style='width:100%;' id='isi_klasifikasi'>
						<option value=".$inventory->id_klasifikasi." >".$inventory->nama_klasifikasi."</option>
					";
					...
					echo"<div class='form-group'>
						<label for='exampleInputEmail1'>Status inventory</label>
							<select name='status' class='form-control'  style='width:100%;'>
								<option value='".$inventory->status_inventory."'>$nama_status</option>
					...
					<div class='form-group'>	
						...
						upload foto/image Sekarang
						</label>
						<br>
						<img src='".base_url('assets/images/inventory/'.$inventory->image_inventory.'')."' width=150 height=200>
					<div><br>";
					}
...
function Function_inventory() {
    ...
    var binv0 = document.getElementById("barcode_inventory0");
    var binv = document.getElementById("barcode_inventory");
    
	$.ajax({
                url: "<?php echo base_url(); ?>" + "index.php/inventory/inventory_cekbarcodeedit?barcode0="+binv0.value+"&barcode="+binv.value,
                type: 'POST',
                dataType: "json",
                success: function(response){
