      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">jenis_member</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel jenis_member</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/jenis_member/jenis_memberadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($jenis_member as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_jenis_member</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/jenis_member/jenis_member_edit?id='.$ktg->id_jenis_member)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/jenis_member/jenis_member_delete?id='.$ktg->id_jenis_member)."\">
