            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel penerbit</h3>
                  <div class="box-tools"> 
					<a href="<?php echo base_url('index.php/penerbit/penerbitadd');?>">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
					...
					foreach($penerbit as $ktg){
					$no++;
					echo "<tr>";
					echo "<td align='center' style='vertical-align:middle'>$nodar</td>
					<td style='vertical-align:middle'>$ktg->nama_penerbit</td>
					
					<td align='center' style='vertical-align:middle'>
					<a href=\"".base_url('index.php/penerbit/penerbit_edit?id='.$ktg->id_penerbit)."\">
					<button class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>
					<a href=\"".base_url('index.php/penerbit/penerbit_delete?id='.$ktg->id_penerbit)."\">
