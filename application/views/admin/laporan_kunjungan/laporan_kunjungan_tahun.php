 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         kunjungan
		  ...
		  <ul class="nav nav-tabs">
			  ...
			  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/laporan_kunjungan/tahun'); ?>">Tahun</a></li>
			</ul>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Kunjungan per tahun </h3><p>
				<a href='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tahun_print');?>'  ><button class='btn btn-primary'> 
				 Print preview</button>
				 </a>
				  <p>
				 
			<?php 
				if(!isset($_GET['search_kunjungan_tahun'])) {
			...
			?>
			<?php
			if ($search_kunjungan_tahun<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_kunjungan_tahun";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tahun');?>' method='get'>
                   <div class="input-group">
				   
                     <input type="number" name="search_kunjungan_tahun" value='<?php echo$this->session->userdata('search_kunjungan_tahun'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_kunjungan_tahun')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tahun?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
