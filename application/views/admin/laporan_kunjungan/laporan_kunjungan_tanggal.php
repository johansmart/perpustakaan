        ...
        <section class="content-header">
         ...
         kunjungan
		  ...
		  <ul class="nav nav-tabs">
			  ...
			  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/laporan_kunjungan/tanggal'); ?>">Tanggal</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Kunjungan per tanggal </h3><p>
				<a href='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tanggal_print');?>'  ><button class='btn btn-primary'> 
				 Print preview</button>
				 </a>
				  <p>
				 
			<?php 
				if(!isset($_GET['search_kunjungan_tanggal'])) {
				$search_kunjungan_tanggal="";
				}
				else {
				$search_kunjungan_tanggal=$_GET['search_kunjungan_tanggal'];
				}
			?>
			<?php
			if ($search_kunjungan_tanggal<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_kunjungan_tanggal";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tanggal');?>' method='get'>
                   <div class="input-group">
				   
                     <input type="text" name="search_kunjungan_tanggal" id='tanggal' value='<?php echo$this->session->userdata('search_kunjungan_tanggal'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_kunjungan_tanggal')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_kunjungan/kunjungan_list_tanggal?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
