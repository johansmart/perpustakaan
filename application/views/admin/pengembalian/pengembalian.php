      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         pengembalian
          ...
          <ol class="breadcrumb">
			<li>
		  	<a href="<?php echo base_url('index.php/pengembalian/pengembalian_add');?>">
        ...
        <section class="content">
			...
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/pengembalian');?>' method='get'>
                   <div class="input-group">
                     <input type="text" name="search_inv" value='<?php echo$this->session->userdata('search_inv'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search_inv"/>
                      <div class="input-group-btn">
						...
						?>
						<a href='<?php echo base_url('index.php/pengembalian?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <th style=width:10%>Denda lain</th>
				...
				foreach($pengembalian as $mn){
					$total=$mn->jumlah_denda_telat+$mn->denda_lainnya;
					$no++;
					echo "<tr>";
			...
			$total_semua = $this->m_pengembalian->pengembalian_printdendahariini();
				foreach($total_semua as $total_semua)
				{
					echo"<br><br><br> Total denda : ".$total_semua->total_semua." <br><br>";
				}
