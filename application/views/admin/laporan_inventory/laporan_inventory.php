      ...
      <div class="content-wrapper">
        ...
        Laporan inventory Buku
		   ...
		   <ul class="nav nav-tabs">
			  <li role="presentation" class="active" ><a href="<?php echo base_url('index.php/laporan_inventory/'); ?>">Data Inventory Buku</a></li>
			  <li role="presentation" ><a href="<?php echo base_url('index.php/laporan_inventory/inventory_stat'); ?>">Statistik Buku</a></li>
			</ul>
          <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
				 ...
				 <p>
				   <a href='<?php echo base_url('index.php/laporan_inventory/inventory_print');?>' target='_blank' ><button class='btn btn-primary'> 
			...
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_inventory');?>' method='get'>
                   <div class="input-group">
                     <input type="text" name="lap_search_inv" value='<?php echo$this->session->userdata('lap_search_inv'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="lap_search_inv"/>
                      <div class="input-group-btn">
						...
						?>
						<a href='<?php echo base_url('index.php/laporan_inventory?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
