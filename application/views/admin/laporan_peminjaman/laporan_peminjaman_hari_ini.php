 ...
 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         Laporan peminjaman
		  ...
		  <ul class="nav nav-tabs">
			  <li role="presentation" class="active" ><a href="<?php echo base_url('index.php/laporan_peminjaman/'); ?>">Hari ini</a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                 <h3 class="box-title">Laporan peminjaman hari ini [ <?php $today=date('D d F Y '); echo"$today";?> ]</h3><p>
				<a href='<?php echo base_url('index.php/laporan_peminjaman/peminjaman_list_hari_ini_print');?>'  target='_blank'><button class='btn btn-primary'> 
			...
			<?php 
				if(!isset($_GET['search_peminjaman'])) {
				$search_peminjaman="";
				}
				else {
				$search_peminjaman=$_GET['search_peminjaman'];
				}
			?>
			<?php
			if ($search_peminjaman<>''){
			?>
				<p>Hasil pencarian dengan keyword : <i><?php echo"$search_peminjaman";?></i>
			<?php
			}
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/laporan_peminjaman/peminjaman_list_hari_ini');?>' method='get'>
                   <div class="input-group">
                     <input type="text" name="search_peminjaman" value='<?php echo$this->session->userdata('search_peminjaman'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
                        <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
						<?php 
						
						if ($this->session->userdata('search_peminjaman')!=''){
						?>
						<a href='<?php echo base_url('index.php/laporan_peminjaman?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
