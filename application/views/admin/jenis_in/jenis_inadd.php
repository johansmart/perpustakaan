              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
					  ...
					  <form action='<?php echo base_url('index.php/jenis_in/jenis_inadd_proses');?>' method='post'>
					   
                      <input type='text' name='jenis_in' class='form-control'  value='' id='exampleInputEmail1' placeholder='nama jenis_in'>
                    </div>
