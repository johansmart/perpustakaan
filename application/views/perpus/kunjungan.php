      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         kunjungan
          ...
          <ol class="breadcrumb">
			<li>
		  	<a href="<?php echo base_url('index.php/perpus/kunjungan');?>">Kunjungan</a>
			</li>
            <li><a href="<?php echo base_url('index.php/perpus');?>"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <section class="content">
			...
			?>
                  <div class="box-tools">
				   <form action='<?php echo base_url('index.php/perpus/kunjungan');?>' method='get'>
                   <div class="input-group">
                     <input type="text" name="search_kunjungan" value='<?php echo$this->session->userdata('search_kunjungan'); ?>' class="form-control input-sm pull-right" style="width: 150px;" placeholder="search"/>
                      <div class="input-group-btn">
						...
						?>
						<a href='<?php echo base_url('index.php/perpus/kunjungan?ref=all');?>'><i class="btn btn-sm btn-default"><i class="fa fa-remove"></i></i></a>
						<?php 
						}
						?>
					  </div>
